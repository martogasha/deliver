...
@include('driverPartial.sidebar')
    <div class="navbar two-action no-hairline">
        <div class="navbar-inner d-flex align-items-center">
            ...
            <div class="sliding custom-title">Client Details</div>
                            ...
                            <div class="panel-body">
                                        ...
                                        <div class="doc-info-cont">
                                            ...
                                            <div class="doc-info custom-info">
                                                <div class="doc-location">
                                                    <p><button class="btn btn-info">{{$booking->user->phone}}</button></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="booking-summary">
                                    ...
                                    <div class="summary-col">
                                        <div class="summary-col-inner">
                                            <div>Driver<span>{{$booking->carrier->first_name}} {{$booking->carrier->last_name}}</span></div>
                                ...
                                <ul>
                                    ...
                                    <form action="{{route('checkIn')}}" method="post">
                                        @csrf
                                        <button class="btn btn-info btn-lg btn-block">Check In</button>
                                    <input type="hidden" name="booking_id" value="{{$booking->id}}">
                                    </form>
                                    @else
                                        <form action="{{route('checkOut')}}" method="post">
                                            @csrf
                                            <button class="btn btn-danger btn-lg btn-block">Check Out</button>
                                            <input type="hidden" name="booking_id" value="{{$booking->id}}">
                                        </form>
                                        @endif
                                        @if($booking->status == 0)
                                        <li class="bottom-button two-button">
                                        <button id="checkInButton">Cancel Request</button>
                                         </li>
                                        @else
                                    @endif
                                </ul>
