...
<div class="main-wrapper">
    ...
    <div class="navbar two-action no-hairline">
        <div class="navbar-inner d-flex align-items-center">
            ...
            <div class="sliding custom-title">Success Rides</div>
                        ...
                        <div class="doctor-widget">
                            <div class="doc-info-left">
                                ...
                                <div class="doc-info-cont">
                                    <h4 class="doc-name"><a href="{{url('successDetails',$booking->id)}}">{{$booking->user->first_name}} {{$booking->user->last_name}}</a></h4>
                            ...
                            <div class="doc-info-right">
                                <div class="clini-infos">
                                    <ul>
                                        @if($booking->status =2 )
                                        <li><i class="far fa-thumbs-up"></i><b style="color:green">Completed</b></li>
                                        @else
                                            <li></li>
                                            @endif
