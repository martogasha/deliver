...
<head>
    ...
    <title>Carrier - HTML Mobile Template</title>
...
<div class="main-wrapper">
    ...
    <div class="page-content change-password-col register-col">
        <div class="list no-hairlines custom-form">
            <div class="back-btn"><a href="{{url('login')}}" class="back link">
            ...
            <div class="register-inner-col">
                <div class="top-title">
                    ...
                    <div>
                        <a href="{{url('register')}}">Not a Carrier?</a>
                    </div>
                </div>
                <form action="{{route('carrierReg')}}" method="post">
                    @csrf
                <ul class="change-list">
                    ...
                    <li class="item-content item-input">
                        <div class="item-col">
                            <div class="item-input-wrap">
                                <input type="text" name="carrier" placeholder="Carrier Type (Motorcycle, Pickup, Lorry, Transit)">
                                <div class="item-input-icon"><img src="assets/img/user-icon.svg" alt=""></div>
                            </div>
                        </div>
                    </li>
                    <li class="item-content item-input">
                        <div class="item-col">
                            <div class="item-input-wrap">
                                <input type="text" name="plates" placeholder="Number Plates">
                                <div class="item-input-icon"><img src="assets/img/user-icon.svg" alt=""></div>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="item-content item-input">
                        <div class="item-input-wrap submit-btn-col">
                            <button type="submit" class="btn btn-submit">Register as Carrier</button>
                        </div>
                    </li>
                </ul>
                </form>
