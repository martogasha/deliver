...
<!-- Mirrored from doccureframework7.dreamguystech.com/bootstrap4/template/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Mar 2021 20:20:10 GMT -->
<head>
    <meta charset="utf-8"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, minimal-ui, viewport-fit=cover">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="#3a57c4">
    <title>Dash - Instant Delivery</title>
            ...
            <div class="top-search">
                <div class="container">
                    <div class="search-area">
                        <form action="https://doccureframework7.dreamguystech.com/bootstrap4/template/search">
                            <div class="list inset">
                                <ul>
                                    ...
                                    <li class="d-flex">
                                        ...
                                        <div class="item-col">
                                            <input type="text" placeholder="GKN Hospital, Bangalore">
                                        </div>
                                    </li>
                                </ul>
                                <a href="search-doctor.html" class="button button-large button-primary btn">Search Now</a>
                            </div>
                        </form>
                    </div>
                </div>
